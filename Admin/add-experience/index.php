                ...
                <form class="mb-9 mt-3">
                    <div class="row g-3 flex-between-end mb-5">
                        ...
                        <div class="col-auto d-flex align-items-center">
                            ...
                            <a id="publishExperience" class="btn btn-primary mb-2 mb-sm-0"><i class="me-1 fs--1" data-feather="check"></i> Publish speaker</a>
                        </div>
                    </div>
                    <div class="row g-5">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-6">
                                                            <div class="form-check">
                                                                <input class="form-check-input" id="flexChecked" type="checkbox">
