            ...
            <div class="content">
                ...
                <form class="mb-9 mt-3">
                    <div class="row g-3 flex-between-end mb-5">
                        <div class="col-auto">
                            <h2 class="mb-2">Florida Proposal</h2>
                            <h5 class="text-700 fw-semi-bold">Proposar generated</h5>
                        </div>
                        <div class="col-auto">
                            <a id="editDiscardProposal" class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0" type="button"><i class="fas fa-trash me-1"></i> Delete</a>
                            <a id="editSaveProposalDraft" class="btn btn-phoenix-primary me-2 mb-2 mb-sm-0" type="button"><i class="me-1 fs--1" data-feather="save"></i> Save draft</a>
                            <a id="editSaveSendProposal" class="btn btn-primary mb-2 mb-sm-0"><i class="me-1 fs--1" data-feather="send"></i> Save and Send</a>
                        </div>
                    </div>
                    <div class="row g-5">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="border-bottom border-dashed border-sm-0 border-bottom-xl pb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="edit_proposal_name" name="edit_proposal_name" value="Florida Proposal">
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                ...
                                                <input type="text" class="form-control" id="edit_proposal_client" name="proposal_client" value="Elizabeth Hernández">
                                            </div>
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="d-flex flex-wrap mb-2">
                                                    <h5 class="text-1000 me-2"><i class="me-1 mb-1 fs--1" data-feather="mail"></i> Client Email</h5>
                                                </div>
                                                <input type="email" class="form-control" id="edit_proposal_email" name="edit_proposal_email" placeholder="client@email.com" value="cyberelizabeth@gmail.com">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-xl-8">
                            ...
                            <div class="border-bottom mb-6 pb-6">
                                ...
                                <select class="form-select select2" id="proposal_speakers_theme" name="proposal_speakers_theme[]" multiple="multiple">
                                    <option value="0" selected>DEI Fundamentals</option>
                                    ...
                                    <option value="8" selected>PRIDE Month</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card p-3 draggable-container">
                                            <div class="row g-2 elements-list" id="editSpeakersList">
                                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-3 draggable-container">
                                            <div class="row g-2 elements-list" id="editSpeakersAdded"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="border-bottom mb-6">
                                ...
                                <textarea class="tinymce" id="edit_proposal_message" name="edit_proposal_message" data-tinymce='{"height":"15rem","placeholder":"Write a description here..."}'></textarea>
                            </div>
                        </div>
